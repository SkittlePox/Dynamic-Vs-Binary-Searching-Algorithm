    ...
    public double search(int[] nums) {
        ...
        for (int x = 0; x < nums.length; x++) {
            ...
            while (upper - lower >= 1) {
                ...
                if ((upper - lower + 1) % 4 == 0) {
                    searchpt = ((upper - lower + 1) / 4) * 3 - 1 + lower;
                } else if ((upper - lower + 1) % 2 == 0) {
                    searchpt = (((upper - lower + 1) - 2) / 4) * 3 + lower;
                } else if ((upper - lower) % 4 == 0) {
                    searchpt = ((upper - lower) / 4) * 3 + lower;
                } else {
                    searchpt = (((upper - lower) - 2) / 4) * 3 + lower + 1;
                }
